    ...
    <div class="text-center mt-5 mb-4">
        <h2 class="fw-bold text-uppercase lh-base titulo-academico">
            <span class="d-block fs-3 text-success">
                R E S P O N S A B I L I D A D - S O C I A L - U N I V E R S I T A R I O
            </span>
        </h2>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    <span class="badge bg-info rounded-circle me-2" style="width:1.5rem; height:1.5rem; display:flex; align-items:center; justify-content:center;">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative d-inline-block">
                                <img src="{{ asset('imagenes/'.$serviceDetail->imagen) }}"
                                    class="img-fluid rounded mb-3" alt="Imagen servicio">

                                <span class="zoom-icon" data-bs-toggle="modal" data-bs-target="#imageZoomModal{{ $serviceDetail->id }}">
                                    <i class="bi bi-zoom-in"></i>
                                </span>
                            </div>

                            {{-- MODAL POR CADA IMAGEN --}}
                            <div class="modal fade" id="imageZoomModal{{ $serviceDetail->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-fullscreen">
                                    <div class="modal-content border-0 bg-dark">
                                        <div class="modal-body d-flex align-items-center justify-content-center position-relative">
                                            ...
                                            <img src="{{ asset('imagenes/'.$serviceDetail->imagen) }}" class="img-modal-zoom">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-center g-4">
                ...
                <div class="col-lg-5 col-md-6">
                    <a href="{{ $feature->url }}" target="_blank" class="feature-box {{ $feature->color }} d-flex justify-content-center align-items-center gap-3 p-4 rounded shadow text-decoration-none text-center">
