...
<main class="main">
    ...
    {{-- =======================
        ALUMNOS TESISTAS
    ======================== --}}
    @if(!empty($alumnotesistas) && $alumnotesistas->count())
    <section id="alumnotesistas" class="mt-4">
        <div class="container">
            <h3 class="mb-3">Tesistas Aptos para la Sustentación</h3>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle text-center">
                    ...
                    <tbody>
                        @foreach($alumnotesistas as $item)
                        <tr>
                            <!-- NUMERO DE ORDEN -->
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary"
                                    ...
                                    data-foto="{{ $item->foto ? asset('imagenes/'.$item->foto) : '' }}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content text-center">
                ...
                <div class="modal-header justify-content-center">
                    <h5 class="modal-title fw-bold" id="modalNombre"></h5>
                    <button type="button"
    ...
    <script>
        ...
        alumnoModal.addEventListener('show.bs.modal', event => {
