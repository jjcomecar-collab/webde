...
<main class="main">
    ...
    <div class="text-center mt-5 mb-4">
        ...
        <div class="mx-auto my-3"
             style="width:150px;height:4px;background:#ffc107;border-radius:5px;">
        </div>
    </div>
    ...
    <section id="service-details" class="section py-5 bg-light">
        <div class="container">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex align-items-center">
                                    <span class="badge bg-info rounded-circle me-2"
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="position-relative d-inline-block mb-3">
                                ...
                                <span class="zoom-icon"
                                      data-bs-toggle="modal"
                                      data-bs-target="#imageZoomModal{{ $serviceDetail->id }}">
            ...
            {{-- MODAL IMAGEN --}}
            @if($serviceDetail->imagen)
            <div class="modal fade" id="imageZoomModal{{ $serviceDetail->id }}" tabindex="-1">
            ...
            <div class="row justify-content-center g-4">
                ...
                <div class="col-lg-5 col-md-6">
                    <a href="{{ $feature->url }}" target="_blank"
                       class="feature-box {{ $feature->color }} d-flex gap-3 p-4 rounded shadow text-decoration-none text-center">
...
@push('styles')
<style>
.titulo-academico { font-family: 'Roboto Condensed', sans-serif; letter-spacing: 2px; }
.img-zoom-external:hover { transform: scale(1.13); transition:.4s; }
.zoom-icon {
...
.zoom-icon:hover { background:rgba(0,0,0,.85); transform:scale(1.1); }
.img-modal-zoom { max-width:70%; max-height:92vh; object-fit:contain; }
.feature-box:hover { transform:translateY(-6px); transition:.3s; }
</style>
@endpush
